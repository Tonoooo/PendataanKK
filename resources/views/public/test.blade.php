<x-guest-layout>
    <div class="w-full sm:max-w-5xl mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        <h1 class="text-2xl font-bold text-center text-gray-800 mb-6">Formulir Data Keluarga</h1>
        ...
        <form action="{{ route('kk.store') }}" method="POST">
            ...
            <fieldset class="border-2 border-gray-300 p-4 rounded-lg">
                <legend class="px-2 font-semibold text-lg text-gray-700">Data Wilayah & Kepala Keluarga</legend>
            ...
            <fieldset class="mt-6 border-2 border-gray-300 p-4 rounded-lg"
                ...
                <legend class="px-2 font-semibold text-lg text-gray-700">Data Anggota Keluarga</legend>

                <template x-for="(orang, index) in anggota" :key="index">
                    <div class="border p-4 mb-4 rounded-md relative bg-gray-50">
                        <h3 class="font-bold mb-3 text-gray-800">Anggota ke-<span x-text="index + 1"></span></h3>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <x-select x-bind:name="`anggota[${index}][status_perkawinan]`" x-model="orang.status_perkawinan" required>
                             ...
                             <div><label class="text-sm text-gray-500">Tgl Perkawinan (Jika ada)</label><x-text-input type="date" x-bind:name="`anggota[${index}][tanggal_perkawinan]`" x-model="orang.tanggal_perkawinan" /></div>
